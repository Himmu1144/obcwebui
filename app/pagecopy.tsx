        ...
        <div className="about-container">
          <div className="about-header">
            ...
            <p className="about-description">
              At Onlybigcars, we are dedicated to providing top-quality car care with unmatched professionalism. Our team of experts is committed to keeping your vehicle running smoothly, ensuring safety and performance with every service. Whether it's routine maintenance or more complex repairs, we deliver reliable, efficient, and affordable solutions for all our customers.
            </p>
            <p className="about-description">
              We understand the importance of your time, which is why we offer convenient online booking and flexible service options. Our goal is to make your experience seamless and stress-free, so you can focus on what matters most – the road ahead!
            </p>
          </div>
